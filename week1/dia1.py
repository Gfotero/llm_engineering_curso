...
# Definiendo el rol del sistema y el usuario
...
# Salida en terminal con libreria RICH
'''
from rich.console import Console
from rich.markdown import Markdown

console = Console()
md = summarize("https://cursos.frogamesformacion.com")  # → tu función
console.print(Markdown(md))
'''

# Salida final con libreria Gradio
import gradio as gr

demo = gr.Interface(
    fn=summarize,
    inputs=gr.Textbox(lines=1, label="URL"),
    outputs=gr.Markdown(label="Resumen"),
    title="Resumen Web en Markdown",
)
